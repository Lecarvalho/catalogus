...
// Dev-only proxy. `pnpm --filter @catalogus/web dev` serves this app on
...
// `catalogus view --no-open` (the --no-open matters: that terminal is not
...
// manifest. The built app (vite build, what `catalogus view` actually
